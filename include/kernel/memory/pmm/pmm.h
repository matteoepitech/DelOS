...
#include <types.h>
    ...
    #ifndef KPMM_PAGE_SIZE
        #define KPMM_PAGE_SIZE 4096
    #endif /* ifndef KPMM_PAGE_SIZE */

    #ifndef KPMM_MIN_BASE
        #define KPMM_MIN_BASE 0x00100000ULL
    #endif /* ifndef KPMM_MIN_BASE */
